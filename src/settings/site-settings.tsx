    ...
    menu: [
      {
        ...
        subMenu: [
            {
                id: 1,
                path: 'https://next13-razor-electronic.vercel.app/en/',
                label: 'menu-home1',
            },
            {
                id: 2,
                path: 'https://next13-razor-electronic.vercel.app/en/home2',
                label: 'menu-home2',
            },
            {
                id: 3,
                path: 'https://next13-razor-electronic.vercel.app/en/home3',
                label: 'menu-home3',
            },
            {
                id: 4,
                path: 'https://next13-razor-electronic.vercel.app/en/home4',
                label: 'menu-home4',
            },
            {
                id: 5,
                path: 'https://next13-razor-electronic.vercel.app/en/home5',
                label: 'menu-home5',
            },
    
            {
                id: 6,
                path: 'https://next13-razor-electronic.vercel.app/en/home6',
                label: 'menu-home6',
            },
            {
                id: 7,
                path: 'https://next13-razor-electronic.vercel.app/en/home7',
                label: 'menu-home7',
            },
            {
                id: 8,
